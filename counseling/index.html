...
<header class="js-header header">
  ...
  <nav class="header__nav">
    <a href="./staff" class="header__nav__link">新着情報</a>
    <a href="./staff" class="header__nav__link">ご利用案内</a>
    <a href="./staff" class="header__nav__link">カウンセラー紹介</a>
    <a href="./staff" class="header__nav__link">会社概要</a>
...
<main>
  <section class="kv">
    <div class="kv__main">
      <h1 class="kv__main__text">こころが軽くなると、<br>世界が少し明るく見える。</h1>
      <p class="kv__main__caption">認知行動療法で、“生きづらさ”を“生きやすさ”へ。<br>安心して暮らせる日常への一歩をサポートします。</p>
    </div>
  </section>
