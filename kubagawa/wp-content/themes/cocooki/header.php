...
<div id="page" class="site">
  <header class="js-header header">
    ...
    <nav class="header__nav">
      ...
      <a href="https://www.instagram.com/kokorookiraku/" target="_blank" class="header__nav__sns"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon_instagram.svg" alt="Instagramへのリンク"></a>
    </nav>
