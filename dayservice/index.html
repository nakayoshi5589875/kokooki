...
<head>
  ...
  <title>ココロおき楽 児童発達支援・放課後等デイサービス・保育所等訪問支援</title>
...
<header class="js-header header">
  ...
  <nav class="header__nav">
    ...
    <a href="./blog" class="header__nav__link">ブログ</a>
    <a href="./#contact" class="header__nav__contact">問い合わせ・ご相談［無料］</a>
    <a href="https://www.instagram.com/kokorookiraku.daycare.teruya?igsh=b3Ftems0cTJxMmIx&utm_source=qr" target="_blank" class="header__nav__sns"><img src="./assets/img/icon_instagram.svg" alt="Instagramへのリンク"></a>
  </nav>
...
<main>
  ...
  <section class="schedule">
    <p class="schedule__deco01"><img src="./assets/img/deco01.png" alt=""></p>
