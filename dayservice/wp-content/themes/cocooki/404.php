...
<main>
  <section class="kv">
    <div class="js-scrollIn u-fadeUp kv__main">
      <h1 class="kv__main__text">子供たちの未来を<br>サポートする</h1>
      <p class="kv__main__caption">ココロおき楽は、<br>利用者の成長とライフサイクルに応じた<br class="sp">支援を提供し、<br>学校適応の促進と将来の社会的自立の<br class="sp">サポートを目指しています。<br>就学に向けてのスムーズな移行と適応を<br class="sp">サポートします。</p>
    </div>
  </section>

  <section class="schedule">
    <p class="schedule__deco01"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/deco01.png" alt=""></p>
    <div class="schedule__wrap">
      <div class="schedule__box">
        <div class="schedule__main">
          ...
          <div class="schedule__flow">
            ...
            <div class="schedule__flow__container">
              <div class="js-scrollIn u-fadeUp schedule__flow__block">
        ...
        <p class="schedule__image"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/phot_image01.jpg" alt=""></p>
        <p class="schedule__deco02"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/deco02.png" alt=""></p>
      </div>
      <div class="schedule__box">
        <div class="schedule__main">
          <hgroup>
        ...
        <p class="schedule__image"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/phot_image02.jpg" alt=""></p>
        <p class="schedule__deco03"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/deco03.png" alt=""></p>
      </div>
    </div>
  </section>
  ...
  <section class="support">
    <div class="support__wrap">
      ...
      <div class="js-scrollIn u-fadeUp support__container">
        ...
        <p class="support__container__illust"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/illust01.png" alt=""></p>
      </div>
    </div>
  </section>
  ...
  <section class="flow">
    <div class="flow__wrap">
      ...
      <ol class="flow__main">
        <li class="js-scrollIn u-fadeUp flow__block">
    ...
    <p class="flow__deco01"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/deco04.png" alt=""></p>
  </section>
  ...
  <section class="blog">
          ...
          <div class="splide__list">
            <a class="splide__slide blog__box" href="">
              <div class="blog__box__top">
                <p class="blog__box__image"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.png" alt=""></p>
    ...
    <div class="blog__bottom">
      <a href="/dayservice/archive/" class="blog__button">
